...
import ColectedStatus from "../../../components/button/ColectedStatus";
            ...
            {content.map((item) => {
              return (
                <TR key={item.id}>
                  ...
                  <TD data-label="Collection DAte">2022/10/10</TD>
                  <TD data-label="amount">100000.00</TD>
                  <TD data-label="credit status"><ColectedStatus colectestatus="deposit" status={1}/></TD>
                  <TD data-label="Biller name">jkary</TD>
